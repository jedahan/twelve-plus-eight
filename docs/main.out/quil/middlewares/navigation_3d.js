...
var vec__13979 = axis;
var a_x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13979,(0),null);
var a_y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13979,(1),null);
var a_z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13979,(2),null);
var vec__13982 = v;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13982,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13982,(1),null);
var z = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13982,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__13985,p__13986){
var vec__13987 = p__13985;
var u1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13987,(0),null);
var u2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13987,(1),null);
var u3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13987,(2),null);
var vec__13990 = p__13986;
var v1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13990,(0),null);
var v2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13990,(1),null);
var v3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13990,(2),null);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__13993_SHARP_){
return (p1__13993_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle(p1__13994_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud(quil.middlewares.navigation_3d.rotate_lr(p1__13995_SHARP_,angle_lr),angle_ud);
...
var map__13997 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13997__$1,cljs.core.cst$kw$up);
var straight = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13997__$1,cljs.core.cst$kw$straight);
var temp__4655__auto__ = (function (){var pred__13999 = cljs.core._EQ_;
var expr__14000 = cljs.core.cst$kw$key.cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_((function (){var G__14002 = cljs.core.cst$kw$w;
var G__14003 = expr__14000;
return (pred__13999.cljs$core$IFn$_invoke$arity$2 ? pred__13999.cljs$core$IFn$_invoke$arity$2(G__14002,G__14003) : pred__13999.call(null,G__14002,G__14003));
})())){
return straight;
} else {
if(cljs.core.truth_((function (){var G__14004 = cljs.core.cst$kw$s;
var G__14005 = expr__14000;
return (pred__13999.cljs$core$IFn$_invoke$arity$2 ? pred__13999.cljs$core$IFn$_invoke$arity$2(G__14004,G__14005) : pred__13999.call(null,G__14004,G__14005));
})())){
return quil.middlewares.navigation_3d.v_opposite(straight);
} else {
if(cljs.core.truth_((pred__13999.cljs$core$IFn$_invoke$arity$2 ? pred__13999.cljs$core$IFn$_invoke$arity$2(quil.middlewares.navigation_3d.space,expr__14000) : pred__13999.call(null,quil.middlewares.navigation_3d.space,expr__14000)))){
return quil.middlewares.navigation_3d.v_opposite(up);
} else {
if(cljs.core.truth_((function (){var G__14006 = cljs.core.cst$kw$z;
var G__14007 = expr__14000;
return (pred__13999.cljs$core$IFn$_invoke$arity$2 ? pred__13999.cljs$core$IFn$_invoke$arity$2(G__14006,G__14007) : pred__13999.call(null,G__14006,G__14007));
})())){
return up;
} else {
if(cljs.core.truth_((function (){var G__14008 = cljs.core.cst$kw$d;
var G__14009 = expr__14000;
return (pred__13999.cljs$core$IFn$_invoke$arity$2 ? pred__13999.cljs$core$IFn$_invoke$arity$2(G__14008,G__14009) : pred__13999.call(null,G__14008,G__14009));
})())){
return quil.middlewares.navigation_3d.cross_product(straight,up);
} else {
if(cljs.core.truth_((function (){var G__14010 = cljs.core.cst$kw$a;
var G__14011 = expr__14000;
return (pred__13999.cljs$core$IFn$_invoke$arity$2 ? pred__13999.cljs$core$IFn$_invoke$arity$2(G__14010,G__14011) : pred__13999.call(null,G__14010,G__14011));
})())){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$navigation_DASH_3d,cljs.core.cst$kw$position], null),((function (dir,temp__4655__auto__,map__13997,map__13997__$1,up,straight){
return (function (p1__13996_SHARP_){
return quil.middlewares.navigation_3d.v_plus(p1__13996_SHARP_,quil.middlewares.navigation_3d.v_mult(dir,step_size));
});})(dir,temp__4655__auto__,map__13997,map__13997__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__14012_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var rotate_on_fn = (function (){var G__14013 = options;
var G__14014 = ((function (G__14013,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed){
return (function (state,_){
return state;
});})(G__14013,user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed))
;
return (rotate_on.cljs$core$IFn$_invoke$arity$2 ? rotate_on.cljs$core$IFn$_invoke$arity$2(G__14013,G__14014) : rotate_on.call(null,G__14013,G__14014));
})();
...
var map__14015_14030 = cljs.core.cst$kw$navigation_DASH_3d.cljs$core$IFn$_invoke$arity$1(state);
var map__14015_14031__$1 = ((((!((map__14015_14030 == null)))?((((map__14015_14030.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14015_14030.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14015_14030):map__14015_14030);
var vec__14016_14032 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14015_14031__$1,cljs.core.cst$kw$straight);
var c_x_14033 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14016_14032,(0),null);
var c_y_14034 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14016_14032,(1),null);
var c_z_14035 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14016_14032,(2),null);
var vec__14019_14036 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14015_14031__$1,cljs.core.cst$kw$up);
var u_x_14037 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14019_14036,(0),null);
var u_y_14038 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14019_14036,(1),null);
var u_z_14039 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14019_14036,(2),null);
var vec__14022_14040 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14015_14031__$1,cljs.core.cst$kw$position);
var p_x_14041 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14022_14040,(0),null);
var p_y_14042 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14022_14040,(1),null);
var p_z_14043 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14022_14040,(2),null);
quil.core.camera.cljs$core$IFn$_invoke$arity$9(p_x_14041,p_y_14042,p_z_14043,(p_x_14041 + c_x_14033),(p_y_14042 + c_y_14034),(p_z_14043 + c_z_14035),u_x_14037,u_y_14038,u_z_14039);
...
var G__14026 = quil.middlewares.navigation_3d.move(state,event,step_size);
var G__14027 = event;
return (key_pressed.cljs$core$IFn$_invoke$arity$2 ? key_pressed.cljs$core$IFn$_invoke$arity$2(G__14026,G__14027) : key_pressed.call(null,G__14026,G__14027));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
,rotate_on,((function (user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup){
return (function (state,event){
var G__14028 = quil.middlewares.navigation_3d.rotate(state,event,pixels_in_360);
var G__14029 = event;
return (rotate_on_fn.cljs$core$IFn$_invoke$arity$2 ? rotate_on_fn.cljs$core$IFn$_invoke$arity$2(G__14028,G__14029) : rotate_on_fn.call(null,G__14028,G__14029));
});})(user_settings,pixels_in_360,step_size,rotate_on,draw,key_pressed,rotate_on_fn,setup))
], 0));
});
