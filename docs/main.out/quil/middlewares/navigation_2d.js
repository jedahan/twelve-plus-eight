...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__14501_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_14502 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_14503 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_14502);
var pos_14504 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_14502);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_14503);

var tr__14424__auto___14505 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_14503) - cljs.core.first(pos_14504)),(((quil.core.height() / (2)) / zoom_14503) - cljs.core.second(pos_14504))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__14424__auto___14505);
...
var G__14506 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__14507 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__14506,G__14507) : user_mouse_dragged.call(null,G__14506,G__14507));
...
return (function (state,event){
var G__14508 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__14509 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__14508,G__14509) : user_mouse_wheel.call(null,G__14508,G__14509));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
